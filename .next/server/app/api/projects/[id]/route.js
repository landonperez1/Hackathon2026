(()=>{var e={};e.id=514,e.ids=[514],e.modules={846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},4870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},9294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},3033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},3873:e=>{"use strict";e.exports=require("path")},7149:(e,t,r)=>{"use strict";r.r(t),r.d(t,{patchFetch:()=>R,routeModule:()=>_,serverHooks:()=>N,workAsyncStorage:()=>u,workUnitAsyncStorage:()=>l});var n={};r.r(n),r.d(n,{DELETE:()=>T,GET:()=>c,PATCH:()=>d,runtime:()=>p});var i=r(2706),o=r(8203),a=r(5994),E=r(9187),s=r(9058);let p="nodejs";async function c(e,{params:t}){let{id:r}=await t,n=(0,s.U1)(r);if(!n)return E.NextResponse.json({error:"not found"},{status:404});let i=(0,s.RQ)(r);return E.NextResponse.json({project:n,files:i})}async function d(e,{params:t}){let{id:r}=await t,n=await e.json(),i=(0,s.vr)(r,n);return i?E.NextResponse.json({project:i}):E.NextResponse.json({error:"not found"},{status:404})}async function T(e,{params:t}){let{id:r}=await t;return(0,s.xx)(r)?E.NextResponse.json({ok:!0}):E.NextResponse.json({error:"not found"},{status:404})}let _=new i.AppRouteRouteModule({definition:{kind:o.RouteKind.APP_ROUTE,page:"/api/projects/[id]/route",pathname:"/api/projects/[id]",filename:"route",bundlePath:"app/api/projects/[id]/route"},resolvedPagePath:"/workspaces/Hackathon2026/app/api/projects/[id]/route.ts",nextConfigOutput:"",userland:n}),{workAsyncStorage:u,workUnitAsyncStorage:l,serverHooks:N}=_;function R(){return(0,a.patchFetch)({workAsyncStorage:u,workUnitAsyncStorage:l})}},6487:()=>{},8335:()=>{},9058:(e,t,r)=>{"use strict";r.d(t,{H8:()=>m,Gu:()=>N,gA:()=>b,sn:()=>H,WM:()=>F,yr:()=>f,H2:()=>L,xx:()=>k,nB:()=>v,SE:()=>D,iH:()=>l,U1:()=>h,c2:()=>G,qT:()=>C,B3:()=>Y,fS:()=>y,A$:()=>S,u0:()=>O,SR:()=>u,RQ:()=>w,hF:()=>X,iE:()=>A,EL:()=>U,Aw:()=>x,l0:()=>j,xs:()=>R,vr:()=>M,fu:()=>P});let n=require("node-sqlite3-wasm");var i=r(3873),o=r.n(i);let a=require("fs");var E=r.n(a);let s=o().join(process.cwd(),"data"),p=o().join(s,"projectmind.db");E().existsSync(s)||E().mkdirSync(s,{recursive:!0});let c=null;function d(e){return Object.fromEntries(Object.entries(e).map(([e,t])=>["@"+e,t]))}function T(){if(c)return c;let e=new n.Database(p);return e.run("PRAGMA journal_mode = WAL"),e.run("PRAGMA foreign_keys = ON"),e.exec(`
  ...
  `),c=e,e}function _(){return crypto.randomUUID()}function u(){return T().prepare("SELECT * FROM people ORDER BY name ASC").all()}function l(e){return T().prepare("SELECT * FROM people WHERE id = ?").get([e])}function N(e){let t={id:_(),name:e.name,role:e.role??"",reliability:e.reliability??3,workload:e.workload??3,communication_style:e.communication_style??"",personality_notes:e.personality_notes??"",created_at:Date.now()};return T().prepare(`INSERT INTO people
       (id, name, role, reliability, workload, communication_style, personality_notes, created_at)
       VALUES (@id, @name, @role, @reliability, @workload, @communication_style, @personality_notes, @created_at)`).run(d(t)),t}function R(e,t){let r=l(e);if(!r)return;let n={...r,...t,id:e};return T().prepare(`UPDATE people SET
         name = @name,
         role = @role,
     ...
     VALUES (?, ?, ?)`);r.run("BEGIN");try{for(let r of(n.run(d(t)),e.person_id&&i.run([t.id,"person",e.person_id]),e.mentions??[]))i.run([t.id,r.type,r.id]);r.run("COMMIT")}catch(e){throw r.run("ROLLBACK"),e}return t}function S(){return T().prepare("SELECT * FROM interaction_mentions").all()}function f(e){return T().prepare("DELETE FROM interactions WHERE id = ?").run([e]).changes>0}function I(e,t){return e<t?[e,t]:[t,e]}function A(){return T().prepare("SELECT * FROM relationships").all()}function j(e,t,r){if(e===t)return null;let[n,i]=I(e,t),o={person_a_id:n,person_b_id:i,strength:r};return T().prepare(`INSERT INTO relationships (person_a_id, person_b_id, strength)
       ...
       VALUES (@id, @project_description, @options_json, @chosen_index, @rating, @feedback, @created_at, @completed_at)`).run(d(r)),t}function x(e,t,r,n){if(C(e))return T().prepare(`UPDATE strategies
       SET chosen_index = ?, rating = ?, feedback = ?, completed_at = ?
       WHERE id = ?`).run([t,r,n,Date.now(),e]),C(e)}function y(e=20){return T().prepare("SELECT * FROM strategies WHERE rating IS NOT NULL ORDER BY completed_at DESC LIMIT ?").all([e]).map(g)}function X(){return T().prepare("SELECT * FROM projects ORDER BY created_at DESC").all()}function h(e){return T().prepare("SELECT * FROM projects WHERE id = ?").get([e])}function b(e){let t={id:_(),name:e.name,description:e.description??"",created_at:Date.now()};return T().prepare(`INSERT INTO projects (id, name, description, created_at)
