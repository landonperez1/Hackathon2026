(()=>{var e={};e.id=64,e.ids=[64],e.modules={846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},4870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},9294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},3033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},3873:e=>{"use strict";e.exports=require("path")},3277:(e,t,r)=>{"use strict";r.r(t),r.d(t,{patchFetch:()=>N,routeModule:()=>T,serverHooks:()=>u,workAsyncStorage:()=>_,workUnitAsyncStorage:()=>l});var n={};r.r(n),r.d(n,{GET:()=>c,POST:()=>d,runtime:()=>p});var i=r(2706),o=r(8203),a=r(5994),E=r(9187),s=r(6448);let p="nodejs";async function c(){return E.NextResponse.json({projects:(0,s.hF)()})}async function d(e){let t=await e.json();if(!t?.name||"string"!=typeof t.name)return E.NextResponse.json({error:"name is required"},{status:400});let r=(0,s.gA)({name:t.name,description:t.description});return E.NextResponse.json({project:r},{status:201})}let T=new i.AppRouteRouteModule({definition:{kind:o.RouteKind.APP_ROUTE,page:"/api/projects/route",pathname:"/api/projects",filename:"route",bundlePath:"app/api/projects/route"},resolvedPagePath:"/workspaces/Hackathon2026/app/api/projects/route.ts",nextConfigOutput:"",userland:n}),{workAsyncStorage:_,workUnitAsyncStorage:l,serverHooks:u}=T;function N(){return(0,a.patchFetch)({workAsyncStorage:_,workUnitAsyncStorage:l})}},6487:()=>{},8335:()=>{},6448:(e,t,r)=>{"use strict";r.d(t,{H8:()=>m,Gu:()=>N,gA:()=>b,sn:()=>H,WM:()=>C,yr:()=>f,H2:()=>L,xx:()=>k,nB:()=>v,SE:()=>g,iH:()=>u,U1:()=>h,c2:()=>G,qT:()=>U,B3:()=>w,fS:()=>x,A$:()=>S,u0:()=>O,SR:()=>l,RQ:()=>Y,hF:()=>X,iE:()=>A,EL:()=>F,Aw:()=>y,l0:()=>j,xs:()=>R,vr:()=>M,fu:()=>P});let n=require("better-sqlite3");var i=r.n(n),o=r(3873),a=r.n(o);let E=require("fs");var s=r.n(E);let p=a().join(process.cwd(),"data"),c=a().join(p,"projectmind.db");s().existsSync(p)||s().mkdirSync(p,{recursive:!0});let d=null;function T(){if(d)return d;let e=new(i())(c);return e.pragma("journal_mode = WAL"),e.pragma("foreign_keys = ON"),e.exec(`
