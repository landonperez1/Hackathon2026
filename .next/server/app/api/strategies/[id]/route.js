(()=>{var e={};e.id=733,e.ids=[733],e.modules={846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},4870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},9294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},3033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},3873:e=>{"use strict";e.exports=require("path")},1871:(e,t,r)=>{"use strict";r.r(t),r.d(t,{patchFetch:()=>u,routeModule:()=>d,serverHooks:()=>l,workAsyncStorage:()=>T,workUnitAsyncStorage:()=>_});var n={};r.r(n),r.d(n,{GET:()=>c,runtime:()=>p});var i=r(2706),o=r(8203),a=r(5994),E=r(9187),s=r(6448);let p="nodejs";async function c(e,{params:t}){let{id:r}=await t,n=(0,s.qT)(r);return n?E.NextResponse.json({strategy:n}):E.NextResponse.json({error:"not found"},{status:404})}let d=new i.AppRouteRouteModule({definition:{kind:o.RouteKind.APP_ROUTE,page:"/api/strategies/[id]/route",pathname:"/api/strategies/[id]",filename:"route",bundlePath:"app/api/strategies/[id]/route"},resolvedPagePath:"/workspaces/Hackathon2026/app/api/strategies/[id]/route.ts",nextConfigOutput:"",userland:n}),{workAsyncStorage:T,workUnitAsyncStorage:_,serverHooks:l}=d;function u(){return(0,a.patchFetch)({workAsyncStorage:T,workUnitAsyncStorage:_})}},6487:()=>{},8335:()=>{},6448:(e,t,r)=>{"use strict";r.d(t,{H8:()=>m,Gu:()=>N,gA:()=>b,sn:()=>H,WM:()=>C,yr:()=>I,H2:()=>L,xx:()=>k,nB:()=>P,SE:()=>j,iH:()=>u,U1:()=>h,c2:()=>G,qT:()=>F,B3:()=>w,fS:()=>X,A$:()=>S,u0:()=>O,SR:()=>l,RQ:()=>Y,hF:()=>x,iE:()=>A,EL:()=>U,Aw:()=>y,l0:()=>g,xs:()=>R,vr:()=>M,fu:()=>v});let n=require("better-sqlite3");var i=r.n(n),o=r(3873),a=r.n(o);let E=require("fs");var s=r.n(E);let p=a().join(process.cwd(),"data"),c=a().join(p,"projectmind.db");s().existsSync(p)||s().mkdirSync(p,{recursive:!0});let d=null;function T(){if(d)return d;let e=new(i())(c);return e.pragma("journal_mode = WAL"),e.pragma("foreign_keys = ON"),e.exec(`
  ...
  `),d=e,e}function _(){return crypto.randomUUID()}function l(){return T().prepare("SELECT * FROM people ORDER BY name ASC").all()}function u(e){return T().prepare("SELECT * FROM people WHERE id = ?").get(e)}function N(e){let t={id:_(),name:e.name,role:e.role??"",reliability:e.reliability??3,workload:e.workload??3,communication_style:e.communication_style??"",personality_notes:e.personality_notes??"",created_at:Date.now()};return T().prepare(`INSERT INTO people
     ...
     VALUES (?, ?, ?)`);return r.transaction(()=>{for(let r of(n.run(t),e.person_id&&i.run(t.id,"person",e.person_id),e.mentions??[]))i.run(t.id,r.type,r.id)})(),t}function S(){return T().prepare("SELECT * FROM interaction_mentions").all()}function I(e){return T().prepare("DELETE FROM interactions WHERE id = ?").run(e).changes>0}function f(e,t){return e<t?[e,t]:[t,e]}function A(){return T().prepare("SELECT * FROM relationships").all()}function g(e,t,r){if(e===t)return null;let[n,i]=f(e,t),o={person_a_id:n,person_b_id:i,strength:r};return T().prepare(`INSERT INTO relationships (person_a_id, person_b_id, strength)
       ...
       VALUES (@id, @project_id, @name, @notes, @storage_path, @original_filename, @mime_type, @size_bytes, @created_at)`).run(t),t}function v(e,t){let r=G(e);if(!r)return;let n={...r,...t};return T().prepare("UPDATE project_files SET name = @name, notes = @notes WHERE id = @id").run(n),n}function P(e){let t=G(e);if(t)return T().prepare("DELETE FROM project_files WHERE id = ?").run(e),t}}};var t=require("../../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),n=t.X(0,[257,452],()=>r(1871));module.exports=n})();