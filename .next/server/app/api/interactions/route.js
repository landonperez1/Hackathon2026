(()=>{var e={};e.id=293,e.ids=[293],e.modules={846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},4870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},9294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},3033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},3873:e=>{"use strict";e.exports=require("path")},1451:(e,t,r)=>{"use strict";r.r(t),r.d(t,{patchFetch:()=>R,routeModule:()=>_,serverHooks:()=>N,workAsyncStorage:()=>l,workUnitAsyncStorage:()=>u});var n={};r.r(n),r.d(n,{GET:()=>c,POST:()=>T,runtime:()=>p});var i=r(2706),o=r(8203),a=r(5994),s=r(9187),E=r(6448);let p="nodejs";async function c(e){return"mentions"===new URL(e.url).searchParams.get("include")?s.NextResponse.json({interactions:(0,E.u0)(),mentions:(0,E.A$)()}):s.NextResponse.json({interactions:(0,E.u0)()})}let d=["person","project","file"];async function T(e){let t=await e.json();if(!t?.content||"string"!=typeof t.content)return s.NextResponse.json({error:"content is required"},{status:400});let r=(Array.isArray(t.mentions)?t.mentions:[]).filter(e=>e&&"string"==typeof e.id&&"string"==typeof e.type&&d.includes(e.type)).map(e=>({type:e.type,id:e.id})),n=(0,E.H8)({person_id:t.person_id??null,content:t.content,project_context:t.project_context,mentions:r});return s.NextResponse.json({interaction:n},{status:201})}let _=new i.AppRouteRouteModule({definition:{kind:o.RouteKind.APP_ROUTE,page:"/api/interactions/route",pathname:"/api/interactions",filename:"route",bundlePath:"app/api/interactions/route"},resolvedPagePath:"/workspaces/Hackathon2026/app/api/interactions/route.ts",nextConfigOutput:"",userland:n}),{workAsyncStorage:l,workUnitAsyncStorage:u,serverHooks:N}=_;function R(){return(0,a.patchFetch)({workAsyncStorage:l,workUnitAsyncStorage:u})}},6487:()=>{},8335:()=>{},6448:(e,t,r)=>{"use strict";r.d(t,{H8:()=>m,Gu:()=>N,gA:()=>b,sn:()=>G,WM:()=>F,yr:()=>f,H2:()=>L,xx:()=>k,nB:()=>v,SE:()=>j,iH:()=>u,U1:()=>h,c2:()=>H,qT:()=>U,B3:()=>w,fS:()=>x,A$:()=>S,u0:()=>O,SR:()=>l,RQ:()=>Y,hF:()=>X,iE:()=>A,EL:()=>D,Aw:()=>C,l0:()=>g,xs:()=>R,vr:()=>M,fu:()=>P});let n=require("better-sqlite3");var i=r.n(n),o=r(3873),a=r.n(o);let s=require("fs");var E=r.n(s);let p=a().join(process.cwd(),"data"),c=a().join(p,"projectmind.db");E().existsSync(p)||E().mkdirSync(p,{recursive:!0});let d=null;function T(){if(d)return d;let e=new(i())(c);return e.pragma("journal_mode = WAL"),e.pragma("foreign_keys = ON"),e.exec(`
