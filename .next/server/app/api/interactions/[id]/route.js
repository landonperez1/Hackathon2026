(()=>{var e={};e.id=109,e.ids=[109],e.modules={846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},4870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},9294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},3033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},3873:e=>{"use strict";e.exports=require("path")},4872:(e,t,r)=>{"use strict";r.r(t),r.d(t,{patchFetch:()=>u,routeModule:()=>d,serverHooks:()=>_,workAsyncStorage:()=>T,workUnitAsyncStorage:()=>l});var n={};r.r(n),r.d(n,{DELETE:()=>c,runtime:()=>E});var i=r(2706),o=r(8203),a=r(5994),s=r(9187),p=r(6448);let E="nodejs";async function c(e,{params:t}){let{id:r}=await t;return(0,p.yr)(r)?s.NextResponse.json({ok:!0}):s.NextResponse.json({error:"not found"},{status:404})}let d=new i.AppRouteRouteModule({definition:{kind:o.RouteKind.APP_ROUTE,page:"/api/interactions/[id]/route",pathname:"/api/interactions/[id]",filename:"route",bundlePath:"app/api/interactions/[id]/route"},resolvedPagePath:"/workspaces/Hackathon2026/app/api/interactions/[id]/route.ts",nextConfigOutput:"",userland:n}),{workAsyncStorage:T,workUnitAsyncStorage:l,serverHooks:_}=d;function u(){return(0,a.patchFetch)({workAsyncStorage:T,workUnitAsyncStorage:l})}},6487:()=>{},8335:()=>{},6448:(e,t,r)=>{"use strict";r.d(t,{H8:()=>S,Gu:()=>N,WM:()=>y,yr:()=>m,H2:()=>R,SE:()=>x,iH:()=>u,qT:()=>U,fS:()=>j,u0:()=>O,SR:()=>_,iE:()=>f,EL:()=>D,Aw:()=>F,l0:()=>g,xs:()=>L});let n=require("better-sqlite3");var i=r.n(n),o=r(3873),a=r.n(o);let s=require("fs");var p=r.n(s);let E=a().join(process.cwd(),"data"),c=a().join(E,"projectmind.db");p().existsSync(E)||p().mkdirSync(E,{recursive:!0});let d=null;function T(){if(d)return d;let e=new(i())(c);return e.pragma("journal_mode = WAL"),e.pragma("foreign_keys = ON"),e.exec(`
  ...
  `),d=e,e}function l(){return crypto.randomUUID()}function _(){return T().prepare("SELECT * FROM people ORDER BY name ASC").all()}function u(e){return T().prepare("SELECT * FROM people WHERE id = ?").get(e)}function N(e){let t={id:l(),name:e.name,role:e.role??"",reliability:e.reliability??3,workload:e.workload??3,communication_style:e.communication_style??"",personality_notes:e.personality_notes??"",created_at:Date.now()};return T().prepare(`INSERT INTO people
       ...
       VALUES (@id, @person_id, @content, @project_context, @created_at)`).run(t),t}function m(e){return T().prepare("DELETE FROM interactions WHERE id = ?").run(e).changes>0}function I(e,t){return e<t?[e,t]:[t,e]}function f(){return T().prepare("SELECT * FROM relationships").all()}function g(e,t,r){if(e===t)return null;let[n,i]=I(e,t),o={person_a_id:n,person_b_id:i,strength:r};return T().prepare(`INSERT INTO relationships (person_a_id, person_b_id, strength)
       ...
       WHERE id = ?`).run(t,r,n,Date.now(),e),U(e)}function j(e=20){return T().prepare("SELECT * FROM strategies WHERE rating IS NOT NULL ORDER BY completed_at DESC LIMIT ?").all(e).map(A)}}};var t=require("../../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),n=t.X(0,[257,452],()=>r(4872));module.exports=n})();