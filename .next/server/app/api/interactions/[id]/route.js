(()=>{var e={};e.id=109,e.ids=[109],e.modules={846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},4870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},9294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},3033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},3873:e=>{"use strict";e.exports=require("path")},4872:(e,t,r)=>{"use strict";r.r(t),r.d(t,{patchFetch:()=>u,routeModule:()=>d,serverHooks:()=>l,workAsyncStorage:()=>T,workUnitAsyncStorage:()=>_});var n={};r.r(n),r.d(n,{DELETE:()=>c,runtime:()=>p});var i=r(2706),o=r(8203),a=r(5994),E=r(9187),s=r(6448);let p="nodejs";async function c(e,{params:t}){let{id:r}=await t;return(0,s.yr)(r)?E.NextResponse.json({ok:!0}):E.NextResponse.json({error:"not found"},{status:404})}let d=new i.AppRouteRouteModule({definition:{kind:o.RouteKind.APP_ROUTE,page:"/api/interactions/[id]/route",pathname:"/api/interactions/[id]",filename:"route",bundlePath:"app/api/interactions/[id]/route"},resolvedPagePath:"/workspaces/Hackathon2026/app/api/interactions/[id]/route.ts",nextConfigOutput:"",userland:n}),{workAsyncStorage:T,workUnitAsyncStorage:_,serverHooks:l}=d;function u(){return(0,a.patchFetch)({workAsyncStorage:T,workUnitAsyncStorage:_})}},6487:()=>{},8335:()=>{},6448:(e,t,r)=>{"use strict";r.d(t,{H8:()=>m,Gu:()=>N,gA:()=>b,sn:()=>G,WM:()=>C,yr:()=>I,H2:()=>L,xx:()=>k,nB:()=>P,SE:()=>D,iH:()=>u,U1:()=>h,c2:()=>H,qT:()=>F,B3:()=>w,fS:()=>X,A$:()=>S,u0:()=>O,SR:()=>l,RQ:()=>Y,hF:()=>x,iE:()=>A,EL:()=>U,Aw:()=>y,l0:()=>g,xs:()=>R,vr:()=>M,fu:()=>v});let n=require("better-sqlite3");var i=r.n(n),o=r(3873),a=r.n(o);let E=require("fs");var s=r.n(E);let p=a().join(process.cwd(),"data"),c=a().join(p,"projectmind.db");s().existsSync(p)||s().mkdirSync(p,{recursive:!0});let d=null;function T(){if(d)return d;let e=new(i())(c);return e.pragma("journal_mode = WAL"),e.pragma("foreign_keys = ON"),e.exec(`
  ...
  `),d=e,e}function _(){return crypto.randomUUID()}function l(){return T().prepare("SELECT * FROM people ORDER BY name ASC").all()}function u(e){return T().prepare("SELECT * FROM people WHERE id = ?").get(e)}function N(e){let t={id:_(),name:e.name,role:e.role??"",reliability:e.reliability??3,workload:e.workload??3,communication_style:e.communication_style??"",personality_notes:e.personality_notes??"",created_at:Date.now()};return T().prepare(`INSERT INTO people
     ...
     VALUES (?, ?, ?)`);return r.transaction(()=>{for(let r of(n.run(t),e.person_id&&i.run(t.id,"person",e.person_id),e.mentions??[]))i.run(t.id,r.type,r.id)})(),t}function S(){return T().prepare("SELECT * FROM interaction_mentions").all()}function I(e){return T().prepare("DELETE FROM interactions WHERE id = ?").run(e).changes>0}function f(e,t){return e<t?[e,t]:[t,e]}function A(){return T().prepare("SELECT * FROM relationships").all()}function g(e,t,r){if(e===t)return null;let[n,i]=f(e,t),o={person_a_id:n,person_b_id:i,strength:r};return T().prepare(`INSERT INTO relationships (person_a_id, person_b_id, strength)
       VALUES (@person_a_id, @person_b_id, @strength)
       ON CONFLICT(person_a_id, person_b_id) DO UPDATE SET strength = excluded.strength`).run(o),o}function D(e,t){let[r,n]=f(e,t);return T().prepare("DELETE FROM relationships WHERE person_a_id = ? AND person_b_id = ?").run(r,n).changes>0}function j(e){return{id:e.id,project_description:e.project_description,options:JSON.parse(e.options_json),chosen_index:e.chosen_index,rating:e.rating,feedback:e.feedback,created_at:e.created_at,completed_at:e.completed_at}}function U(e=50){return T().prepare("SELECT * FROM strategies ORDER BY created_at DESC LIMIT ?").all(e).map(j)}function F(e){let t=T().prepare("SELECT * FROM strategies WHERE id = ?").get(e);return t?j(t):void 0}function C(e){let t={id:_(),project_description:e.project_description,options:e.options,chosen_index:null,rating:null,feedback:null,created_at:Date.now(),completed_at:null};return T().prepare(`INSERT INTO strategies
       (id, project_description, options_json, chosen_index, rating, feedback, created_at, completed_at)
       VALUES (@id, @project_description, @options_json, @chosen_index, @rating, @feedback, @created_at, @completed_at)`).run({id:t.id,project_description:t.project_description,options_json:JSON.stringify(t.options),chosen_index:t.chosen_index,rating:t.rating,feedback:t.feedback,created_at:t.created_at,completed_at:t.completed_at}),t}function y(e,t,r,n){if(F(e))return T().prepare(`UPDATE strategies
       SET chosen_index = ?, rating = ?, feedback = ?, completed_at = ?
       WHERE id = ?`).run(t,r,n,Date.now(),e),F(e)}function X(e=20){return T().prepare("SELECT * FROM strategies WHERE rating IS NOT NULL ORDER BY completed_at DESC LIMIT ?").all(e).map(j)}function x(){return T().prepare("SELECT * FROM projects ORDER BY created_at DESC").all()}function h(e){return T().prepare("SELECT * FROM projects WHERE id = ?").get(e)}function b(e){let t={id:_(),name:e.name,description:e.description??"",created_at:Date.now()};return T().prepare(`INSERT INTO projects (id, name, description, created_at)
