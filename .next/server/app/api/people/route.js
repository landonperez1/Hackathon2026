(()=>{var e={};e.id=359,e.ids=[359],e.modules={846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},4870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},9294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},3033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},3873:e=>{"use strict";e.exports=require("path")},9039:(e,t,r)=>{"use strict";r.r(t),r.d(t,{patchFetch:()=>N,routeModule:()=>T,serverHooks:()=>u,workAsyncStorage:()=>_,workUnitAsyncStorage:()=>l});var n={};r.r(n),r.d(n,{GET:()=>c,POST:()=>d,runtime:()=>p});var i=r(2706),o=r(8203),a=r(5994),E=r(9187),s=r(9058);let p="nodejs";async function c(){return E.NextResponse.json({people:(0,s.SR)()})}async function d(e){let t=await e.json();if(!t?.name||"string"!=typeof t.name)return E.NextResponse.json({error:"name is required"},{status:400});let r=(0,s.Gu)({name:t.name,role:t.role,reliability:t.reliability,workload:t.workload,communication_style:t.communication_style,personality_notes:t.personality_notes});return E.NextResponse.json({person:r},{status:201})}let T=new i.AppRouteRouteModule({definition:{kind:o.RouteKind.APP_ROUTE,page:"/api/people/route",pathname:"/api/people",filename:"route",bundlePath:"app/api/people/route"},resolvedPagePath:"/workspaces/Hackathon2026/app/api/people/route.ts",nextConfigOutput:"standalone",userland:n}),{workAsyncStorage:_,workUnitAsyncStorage:l,serverHooks:u}=T;function N(){return(0,a.patchFetch)({workAsyncStorage:_,workUnitAsyncStorage:l})}},6487:()=>{},8335:()=>{},9058:(e,t,r)=>{"use strict";r.d(t,{H8:()=>m,Gu:()=>N,gA:()=>b,sn:()=>P,WM:()=>U,yr:()=>I,H2:()=>L,xx:()=>k,nB:()=>v,SE:()=>D,iH:()=>u,U1:()=>h,c2:()=>G,qT:()=>C,B3:()=>Y,fS:()=>x,A$:()=>S,u0:()=>O,SR:()=>l,RQ:()=>w,hF:()=>X,iE:()=>A,EL:()=>y,Aw:()=>F,l0:()=>j,xs:()=>R,vr:()=>M,fu:()=>H});let n=require("node-sqlite3-wasm");var i=r(3873),o=r.n(i);let a=require("fs");var E=r.n(a);let s=process.env.PROJECTMIND_DATA_DIR??o().join(process.cwd(),"data"),p=o().join(s,"projectmind.db");E().existsSync(s)||E().mkdirSync(s,{recursive:!0});let c=null;function d(e){return Object.fromEntries(Object.entries(e).map(([e,t])=>["@"+e,t]))}function T(){if(c)return c;let e=new n.Database(p);return e.run("PRAGMA journal_mode = WAL"),e.run("PRAGMA foreign_keys = ON"),e.exec(`
