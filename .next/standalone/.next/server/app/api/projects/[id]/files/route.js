(()=>{var e={};e.id=226,e.ids=[226],e.modules={846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},4870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},9294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},3033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},9748:e=>{"use strict";e.exports=require("fs/promises")},3873:e=>{"use strict";e.exports=require("path")},7038:(e,t,r)=>{"use strict";r.r(t),r.d(t,{patchFetch:()=>I,routeModule:()=>L,serverHooks:()=>S,workAsyncStorage:()=>f,workUnitAsyncStorage:()=>O});var n={};r.r(n),r.d(n,{GET:()=>R,POST:()=>m,runtime:()=>l});var i=r(2706),o=r(8203),a=r(5994),s=r(9187),E=r(3873),p=r.n(E),c=r(9748),d=r.n(c),T=r(9058);let l="nodejs",_=process.env.PROJECTMIND_DATA_DIR??p().join(process.cwd(),"data"),u=p().join(_,"files");async function N(){await d().mkdir(u,{recursive:!0})}async function R(e,{params:t}){let{id:r}=await t;return(0,T.U1)(r)?s.NextResponse.json({files:(0,T.RQ)(r)}):s.NextResponse.json({error:"not found"},{status:404})}async function m(e,{params:t}){let{id:r}=await t;if(!(0,T.U1)(r))return s.NextResponse.json({error:"project not found"},{status:404});if((e.headers.get("content-type")??"").includes("multipart/form-data")){let t=await e.formData(),n=t.get("name")??"",i=t.get("notes")??"",o=t.get("file");if(!n.trim()&&!o)return s.NextResponse.json({error:"name or file is required"},{status:400});let a=null,E=null,c=null,l=null;if(o){await N();let e=crypto.randomUUID(),t=p().extname(o.name),r=`${e}${t}`,n=p().join(u,r),i=Buffer.from(await o.arrayBuffer());await d().writeFile(n,i),a=`files/${r}`,E=o.name,c=o.type||null,l=i.length}let _=(0,T.sn)({project_id:r,name:n.trim()||E||"Untitled",notes:i,storage_path:a,original_filename:E,mime_type:c,size_bytes:l});return s.NextResponse.json({file:_},{status:201})}let n=await e.json().catch(()=>null);if(!n?.name||"string"!=typeof n.name)return s.NextResponse.json({error:"name is required"},{status:400});let i=(0,T.sn)({project_id:r,name:n.name,notes:n.notes??""});return s.NextResponse.json({file:i},{status:201})}let L=new i.AppRouteRouteModule({definition:{kind:o.RouteKind.APP_ROUTE,page:"/api/projects/[id]/files/route",pathname:"/api/projects/[id]/files",filename:"route",bundlePath:"app/api/projects/[id]/files/route"},resolvedPagePath:"/workspaces/Hackathon2026/app/api/projects/[id]/files/route.ts",nextConfigOutput:"standalone",userland:n}),{workAsyncStorage:f,workUnitAsyncStorage:O,serverHooks:S}=L;function I(){return(0,a.patchFetch)({workAsyncStorage:f,workUnitAsyncStorage:O})}},6487:()=>{},8335:()=>{},9058:(e,t,r)=>{"use strict";r.d(t,{H8:()=>f,Gu:()=>N,gA:()=>M,sn:()=>P,WM:()=>C,yr:()=>S,H2:()=>m,xx:()=>w,nB:()=>B,SE:()=>g,iH:()=>u,U1:()=>h,c2:()=>G,qT:()=>y,B3:()=>Y,fS:()=>x,A$:()=>O,u0:()=>L,SR:()=>_,RQ:()=>k,hF:()=>X,iE:()=>j,EL:()=>U,Aw:()=>F,l0:()=>A,xs:()=>R,vr:()=>b,fu:()=>v});let n=require("node-sqlite3-wasm");var i=r(3873),o=r.n(i);let a=require("fs");var s=r.n(a);let E=process.env.PROJECTMIND_DATA_DIR??o().join(process.cwd(),"data"),p=o().join(E,"projectmind.db");s().existsSync(E)||s().mkdirSync(E,{recursive:!0});let c=null;function d(e){return Object.fromEntries(Object.entries(e).map(([e,t])=>["@"+e,t]))}function T(){if(c)return c;let e=new n.Database(p);return e.run("PRAGMA journal_mode = WAL"),e.run("PRAGMA foreign_keys = ON"),e.exec(`
  ...
  `),c=e,e}function l(){return crypto.randomUUID()}function _(){return T().prepare("SELECT * FROM people ORDER BY name ASC").all()}function u(e){return T().prepare("SELECT * FROM people WHERE id = ?").get([e])}function N(e){let t={id:l(),name:e.name,role:e.role??"",reliability:e.reliability??3,workload:e.workload??3,communication_style:e.communication_style??"",personality_notes:e.personality_notes??"",created_at:Date.now()};return T().prepare(`INSERT INTO people
     ...
     VALUES (?, ?, ?)`);r.run("BEGIN");try{for(let r of(n.run(d(t)),e.person_id&&i.run([t.id,"person",e.person_id]),e.mentions??[]))i.run([t.id,r.type,r.id]);r.run("COMMIT")}catch(e){throw r.run("ROLLBACK"),e}return t}function O(){return T().prepare("SELECT * FROM interaction_mentions").all()}function S(e){return T().prepare("DELETE FROM interactions WHERE id = ?").run([e]).changes>0}function I(e,t){return e<t?[e,t]:[t,e]}function j(){return T().prepare("SELECT * FROM relationships").all()}function A(e,t,r){if(e===t)return null;let[n,i]=I(e,t),o={person_a_id:n,person_b_id:i,strength:r};return T().prepare(`INSERT INTO relationships (person_a_id, person_b_id, strength)
       ...
       VALUES (@id, @project_id, @name, @notes, @storage_path, @original_filename, @mime_type, @size_bytes, @created_at)`).run(d(t)),t}function v(e,t){let r=G(e);if(!r)return;let n={...r,...t};return T().prepare("UPDATE project_files SET name = @name, notes = @notes WHERE id = @id").run(d(n)),n}function B(e){let t=G(e);if(t)return T().prepare("DELETE FROM project_files WHERE id = ?").run([e]),t}}};var t=require("../../../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),n=t.X(0,[257,452],()=>r(7038));module.exports=n})();