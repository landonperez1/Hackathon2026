(()=>{var e={};e.id=638,e.ids=[638],e.modules={846:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},4870:e=>{"use strict";e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},3295:e=>{"use strict";e.exports=require("next/dist/server/app-render/after-task-async-storage.external.js")},9294:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-async-storage.external.js")},3033:e=>{"use strict";e.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},3873:e=>{"use strict";e.exports=require("path")},473:(e,t,r)=>{"use strict";r.r(t),r.d(t,{patchFetch:()=>l,routeModule:()=>d,serverHooks:()=>u,workAsyncStorage:()=>T,workUnitAsyncStorage:()=>_});var n={};r.r(n),r.d(n,{POST:()=>c,runtime:()=>p});var i=r(2706),o=r(8203),a=r(5994),E=r(9187),s=r(9058);let p="nodejs";async function c(e,{params:t}){let{id:r}=await t,n=await e.json(),i=n?.chosen_index,o=n?.rating;if("number"!=typeof i||"number"!=typeof o||o<1||o>5)return E.NextResponse.json({error:"chosen_index (number) and rating (1-5 number) are required"},{status:400});let a="string"==typeof n?.feedback?n.feedback:"",p=(0,s.Aw)(r,i,o,a);return p?E.NextResponse.json({strategy:p}):E.NextResponse.json({error:"not found"},{status:404})}let d=new i.AppRouteRouteModule({definition:{kind:o.RouteKind.APP_ROUTE,page:"/api/strategies/[id]/rate/route",pathname:"/api/strategies/[id]/rate",filename:"route",bundlePath:"app/api/strategies/[id]/rate/route"},resolvedPagePath:"/workspaces/Hackathon2026/app/api/strategies/[id]/rate/route.ts",nextConfigOutput:"standalone",userland:n}),{workAsyncStorage:T,workUnitAsyncStorage:_,serverHooks:u}=d;function l(){return(0,a.patchFetch)({workAsyncStorage:T,workUnitAsyncStorage:_})}},6487:()=>{},8335:()=>{},9058:(e,t,r)=>{"use strict";r.d(t,{H8:()=>m,Gu:()=>N,gA:()=>h,sn:()=>P,WM:()=>F,yr:()=>f,H2:()=>L,xx:()=>k,nB:()=>v,SE:()=>j,iH:()=>l,U1:()=>b,c2:()=>G,qT:()=>U,B3:()=>Y,fS:()=>x,A$:()=>S,u0:()=>O,SR:()=>u,RQ:()=>w,hF:()=>X,iE:()=>A,EL:()=>C,Aw:()=>y,l0:()=>g,xs:()=>R,vr:()=>M,fu:()=>H});let n=require("node-sqlite3-wasm");var i=r(3873),o=r.n(i);let a=require("fs");var E=r.n(a);let s=process.env.PROJECTMIND_DATA_DIR??o().join(process.cwd(),"data"),p=o().join(s,"projectmind.db");E().existsSync(s)||E().mkdirSync(s,{recursive:!0});let c=null;function d(e){return Object.fromEntries(Object.entries(e).map(([e,t])=>["@"+e,t]))}function T(){if(c)return c;let e=new n.Database(p);return e.run("PRAGMA journal_mode = WAL"),e.run("PRAGMA foreign_keys = ON"),e.exec(`
